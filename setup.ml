...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7eea38231be118b0246608005eb02412) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_distributed", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/essdotteedot/distributed";
          bugreports = None;
          synopsis =
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Distributed"];
                      lib_pack = false;
                      lib_internal_modules = ["Potpourri"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Distributed_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "distributed";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_distributed.ml"
                   });
               Test
                 ({
                     cs_name = "test_distributed";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "examples/basic_example";
                      bs_compiled_object = Native;
                      bs_build_depends =
                        [
                           InternalLibrary "distributed-lwt";
                           FindlibPackage ("logs.lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {exec_custom = false; exec_main_is = "basic.ml"});
               Executable
                 ({
                     cs_name = "ping";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "examples/ping_pong_example";
                      bs_compiled_object = Native;
                      bs_build_depends =
                        [
                           InternalLibrary "distributed-lwt";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "examples/name_server_example";
                      bs_compiled_object = Native;
                      bs_build_depends =
                        [
                           InternalLibrary "distributed-lwt";
                   ...
                   {exec_custom = false; exec_main_is = "name_server.ml"});
               Executable
                 ({
                     cs_name = "add_server";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "add_server.ml"});
               Executable
                 ({
                     cs_name = "add_client";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "add_client.ml"});
               Doc
                 ({
                     cs_name = "distributed-api";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "API reference for distributed";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/essdotteedot/distributed.git";
                      src_repo_browser =
                        Some "https://github.com/essdotteedot/distributed";
     ...
     oasis_digest = Some "Rw\"\004j\031#d\207\144~\208\160\182\158^";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

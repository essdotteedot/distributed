...
(* OASIS_START *)
(* DO NOT EDIT (digest: 49aed6c8c8be755e712e1bf2bedae674) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "distributed-lwt"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_digest = Some "\189\197\174\227q\219\002\255bT>\221\233\211D\201";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
